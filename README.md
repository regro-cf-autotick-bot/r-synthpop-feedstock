...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-synthpop-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-synthpop-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install r-synthpop
```
...
It is possible to list all of the versions of `r-synthpop` available on your platform:
...
```
pixi search r-synthpop --channel conda-forge
```
